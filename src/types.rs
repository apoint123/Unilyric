...
//=============================================================================
// 9. 批量转换相关结构体 (Batch Conversion Structs)
//=============================================================================
...
impl BatchFileId {
    ...
    pub fn new() -> Self {
        ...
        BatchFileId(COUNTER.fetch_add(1, Ordering::SeqCst))
    }
}
...
impl BatchConfigId {
    ...
    pub fn new() -> Self {
        use std::sync::atomic::{AtomicU64, Ordering};
        static COUNTER: AtomicU64 = AtomicU64::new(0);
        BatchConfigId(COUNTER.fetch_add(1, Ordering::SeqCst))
    }
}
...
pub struct BatchConversionConfig {
    ...
    pub translation_lyric_id: Option<BatchFileId>,
    pub romanization_lyric_id: Option<BatchFileId>,
...
impl BatchConversionConfig {
    pub fn new(
        ...
        Self {
            ...
            main_lyric_id,
            translation_lyric_id: None,
            romanization_lyric_id: None,
            target_format,
            output_filename_preview: output_filename,
            status: BatchEntryStatus::Pending,
            ui_id: egui::Id::new(rand::random::<u64>()),
            last_error: None,
        }
    }
}
...
pub enum LyricFileTypeDragSource {
    MainLyric,
    TranslationLyric,
    RomanizationLyric,
}
